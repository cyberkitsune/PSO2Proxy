...
login_config = config.YAMLConfig("cfg/loginmessage.config.yml", {'message': "{{yel}}Welcome to PSO2Proxy! There are currently {client_count} client(s) connected.\nUse {command_prefix}help for command help.", 'messageType': 0x3}, True)
