...
def EQBody(body, ship): # 0 is ship1
    ...
    for client in data.clients.connectedClients.values():
        ...
        if isinstance(chandle, ShipProxy) and client.preferences.get_preference('eqnotice') and (ship == data.clients.get_ship_from_port(chandle.transport.getHost().port)-1):
